...
Async daily standups for small teams. No accounts. No meetings.
...
- Create or join a team with a 6-character code — no account needed
...
4. (Optional) run the seed script: `npx ts-node --compiler-options '{"module":"CommonJS"}' src/scripts/seed.ts`
